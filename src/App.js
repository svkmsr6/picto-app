...
class App extends Component {
  ...
  onChangeView(view, selectedPicData){
    this.setState({ 
      view,
      selectedPicData
    });
        ...
        { 
          (this.state.view === 'user') ? 
            <UserView
              ...
              selectPic={(view, picData) => this.onChangeView(view, picData)}
            /> : 
            <PictureView
              selectedPicData={this.state.selectedPicData}
              goBack={() => this.onChangeView('user', {})} 
            />
        }
      </div>
    );
